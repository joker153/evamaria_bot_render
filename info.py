...
BOT_TOKEN = environ.get('BOT_TOKEN', '1970829702:AAFDF5g1c3vc9z3RPLFTPELurC17IiRJ3Ug')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001481355049 -1001695699917').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://amal:amal@cluster0.dlmfo.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "amalser")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Anurag_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001568469839'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'cineflix_group')
